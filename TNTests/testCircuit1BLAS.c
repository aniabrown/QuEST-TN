...
int main (int narg, char *varg[]) {
    ...
    int tensor1Contractions[1] = {1};
    int tensor2Contractions[1] = {1};
    int tensor1FreeIndices[1] = {0};
    int tensor2FreeIndices[1] = {0};

    Tensor outputTensor = contractIndices(tn.tensors[0], tn.tensors[1], 
            tensor1Contractions, tensor2Contractions, 1, 
            tensor1FreeIndices, 1, 
            tensor2FreeIndices, 1, 
            env);
    printf("Tensor 0\n");
    ...
    int correctOutcome = compareStates(outputTensor.qureg, qubits, 10e-10);
    printf("\n**************************************************\n");
